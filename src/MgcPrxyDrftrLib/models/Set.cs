...
namespace MgcPrxyDrftrLib.models
{
    ...
    public enum Layout { Adventure, Aftermath, ArtSeries, Augment, Class, DoubleFacedToken, Emblem, Flip, Host, Leveler, Meld, ModalDfc, Normal, Planar, ReversibleCard, Saga, Scheme, Split, Token, Transform, Vanguard };
